...
namespace LipshMinimization.ELipschitzMath
{
    public static class MathStrategy
    {
        ...
        /// <summary>
        /// Модификация метода равномерного перебора поиска глобального минимума для эпсилон-липшицевых функций
        /// </summary>
        /// <param name="F">Исследуемая на глобальный минимум функция</param>
        /// <param name="a">Левая граница отрезка</param>
        /// <param name="b">Правая граница отрезка</param>
        ...
        /// <summary>
        /// Модификация метода равномерного перебора поиска глобального минимума для эпсилон-липшицевых функций двух переменных
        /// </summary>
        /// <param name="F">Исследуемая на глобальный минимум функция</param>
